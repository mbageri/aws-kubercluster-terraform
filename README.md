...
After creating the cluster on OpenStack, Terraform created a `ansible_inventory` file . It contains the machine names and IP addresses for the cluster.
...
## Install Kubernetes dependencies on all servers
 `$ ansible-playbook -i ansible_inventory playbooks/kube-dependencies.yml`

## Initialize the master node
 `$ ansible-playbook -i ansible_inventory playbooks/master.yml`
...
## Add the worker nodes
 `$ ansible-playbook -i ansible_inventory playbooks/workers.yml`
